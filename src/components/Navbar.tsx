...
const Navbar: FC<NavbarProps> = ({}) => {
  ...
  return (
    ...
    <nav
      className={`border-gray-200 bg-background dark:bg-darkBackground dark:border-gray-700 fixed md:top-0 max-md:bottom-0 w-full z-50  `}
    >
      <div className=" w-full md:max-w-screen flex items-center justify-center mx-auto px-2 pb-2 md:p-4  ">
        <div className={` w-full md:block md:w-auto" id="navbar-solid-bg`}>
          ...
          {!isSmallScreen && (
            <motion.ul
              initial="hidden"
              animate={isNavbarSolid ? "visible" : "hidden"}
